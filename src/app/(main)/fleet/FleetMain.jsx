...
import { faTools, faCalendarAlt, faLeaf, faMoneyBillWave, faCar, faSprayCan, faCouch } from "@fortawesome/free-solid-svg-icons";
  ...
  return (
    ...
    >
      ...
      <Box sx={{ maxWidth: "1110px", mb: 10 }}>
        <Box sx={{ mb: 8 }}>
          <ServiceTitle>FleetCare</ServiceTitle>
          <ServiceSubtitle>WagenPark Maintenance - Professional Maintenance for your Fleet</ServiceSubtitle>
          <Typography
            sx={{
              textAlign: "center",
              maxWidth: "1110px",
          ...
          >
            At Fast Clean Service we offer a complete and worry-free service with WagenPark Maintenance maintenance solution for
            business fleets. We understand that your vehicles have a are the calling card of your company, and that is why we
            ensure that every vehicle is always there looks representative. With our mobile service we perform maintenance on
            location, which takes some time and save costs, without having to interrupt your business operations.
          </Typography>
        </Box>
          ...
          <Grid container spacing={4}>
            <Grid item xs={12} md={4}>
              <ServiceCard>
                ...
                <Typography
                  sx={{ color: theme.palette.mode === "dark" ? "#D5D5D5" : "#000", fontSize: "1.4rem", fontWeight: "300" }}
                >
        ...
        >
          We focus on high quality using the latest techniques and environmentally friendly products. Your vehicles stay in top
          condition for longer, which ensures a sustainable and professional fleet.
        </Typography>
      </Box>
      <Form />
    </Container>
