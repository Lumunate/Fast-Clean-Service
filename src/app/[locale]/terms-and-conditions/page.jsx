        ...
        content: [
            {
                ...
                text: [
                    ...
                    t("sections.definitions.content.3"),
                    t("sections.definitions.content.4"),
                    t("sections.definitions.content.5"),
                ]
            },
            {
            ...
            },
            {
                ...
                text: [
                    ...
                    t("sections.articles.8.content.2"),
                    t("sections.articles.8.content.3"),
                ]
            },
            {
                ...
                text: [
                    ...
                    t("sections.articles.9.content.2"),
                ]
            },
            {
                heading: t("sections.articles.10.title"),
                text: [
