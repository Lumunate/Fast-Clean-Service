...
export const metadata = {
  ...
  description:
    "Fleet Care Pro by Fast Clean Service provides professional fleet maintenance and cleaning services. We ensure your company's vehicles remain in top condition with customized packages and regular upkeep.",
  keywords:
    "fleet maintenance, fleet cleaning, corporate vehicle care, professional fleet service, commercial vehicle detailing, company car cleaning, fleet service packages, Fast Clean Service",
  ...
  openGraph: {
    ...
    description:
      "Fleet Care Pro offers expert cleaning and maintenance services for corporate and business fleets, ensuring top performance and a professional appearance.",
  ...
  twitter: {
    ...
    description:
      "Professional fleet maintenance services to keep your business vehicles clean and well-maintained. Customizable plans for every fleet size!",
