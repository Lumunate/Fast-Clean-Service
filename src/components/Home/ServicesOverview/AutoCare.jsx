        ...
        <ServicesGrid>
          <ServicesItem>
            ...
            <ServiceContent className="service__content">
              ...
              >
                <ServiceBtn1
                  onClick={() => (window.location.href = "/autocare")}
                >
          ...
          <ServicesItem
            sx={{
              marginTop: "-2.5rem",
              "@media (max-width: 1400px)": { marginTop: 0 },
            }}
          >
            <PkgImgCtr
              //  img="/bike2.jpg"
