...
const OverServiceOverview: React.FC = () => {
  return (
    <HomePkgsInBox
      sx={{
        margin: "0 auto",
    ...
    >
      <ServicesOverviewWrapper>
        ...
        >
          At Fast Clean Service we offer a wide range of services to keep your car
          in top condition to
          <span className="line-break">
            <br />
          </span>
          keep. From exterior to interior, we have the expertise and techniques to
          do each aspect of your vehicle.
        </Typography>
...
export default OverServiceOverview;
