...
export const CardDesc = styled(Typography)(({ theme }) => ({
  ...
  "@media (max-width:900px)": { alignItems: "flex-start", fontSize: "1.2rem" },
...
export const CarouselContentItem = styled(Box)(({ theme }) => ({
  ...
  height: "36rem",
  overflow: "hidden",
  backgroundColor: theme.palette.mode === "light" ? "rgba(255, 255, 255, 0.8)" : "rgba(0, 0, 0, 0.01)", // Light mode: minimal opacity; Dark mode: further reduced opacity
