...
export const ExitIntentProvider = ({ children }) => {
  ...
  const getModalContent = (currentPath, leaveUrl, handleDismiss) => {
    const contentMap = {
      '/booking': [
        {
          ...
          description:
            'Schedule a proper one-time cleanup for your fleet of vehicles! We provide you with the best autocare possible!',
          buttons: [
            {
              label: 'Book Now!',
              variant: 'contained',
        ...
        },
        {
          ...
          description:
            'Book a one-time cleanup for your boats, bikes, etc. Any type of vehicle? We provide services for all!',
          buttons: [
            {
              label: 'Book Now!',
              variant: 'contained',
      ...
      '/fleet': {
        ...
        title: 'Book a Fleet Cleanup Now',
        description:
          "Your fleet isn't ready yet? Try booking a service for your car!",
        buttons: [
          {
            label: 'Book Now!',
            variant: 'contained',
      ...
      '/other-vehicles': {
        ...
        title: 'Book Other Vehicle Cleanup',
        description:
          "Don't have any other vehicles in mind? Try booking a service for your car!",
        buttons: [
          {
            label: 'Book Now!',
            variant: 'contained',
    ...
    (redirectUrl = null) => {
      ...
      if (content) {
        ...
        setModalContent({
          ...
          description:
            'We would love to assist you further before you navigate away.',
          buttons: [
            {
              label: 'Stay',
              variant: 'outlined',
  ...
  const handleMouseLeave = useCallback(
    (e) => {
      ...
      if (e.clientY < 5 && !modalOpen) {
        // Threshold for exit intent
        const currentPath = window.location.pathname;
        if (ALLOWED_PATHS.includes(currentPath)) {
